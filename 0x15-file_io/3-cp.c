...
/**
* copy_file - a function that copies
* a file to another.
*
...
/**
* error_close - error procedure when
* issue with closing.
*
...
/**
* error_file_from - error procedure
* when issue with file from.
*
...
/**
* error_file_to - error procedure when
* file to cannot be created.
*
* @file_to: name of the file to.
* @buf: buffer to be freed.
*
* Return: void
*/
